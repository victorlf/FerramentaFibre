...
def download_web_image(url):
    ...
    full_name = str(name) + "stdin.jpg"
    urllib.urlretrieve(url, full_name)

download_web_image("http://www.lirent.net/wp-content/uploads/2008/07/xkillubuntufreezeapps.png")
'''
...
#web crawler
'''
import requests #request information from a web page
from bs4 import BeautifulSoup

def trade_spider(max_pag):
    page = 1

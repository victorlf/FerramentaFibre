...
def reWriteExp(sq3Name, nodes, transf, bitRate):
    ...
    exp = "tcp_bitrate_experiment.rb"

    lines = open("/home/victor/mysite/bokehApps/UFGtcpBitrate/experiments/" + exp)
    new_lines = list()
    for line in lines:
    ...
    arq = open("/home/victor/mysite/bokehApps/UFGtcpBitrate/experiments/" + exp, "w")
...
def insereTabela(arquivo, ss, rtt):
    params = []
    ...
    if ss == False:
        ...
        table = "INSERT INTO \"ss_rtt\""
        insere = "INSERT INTO SS_RTT  (OML_TUPLE_ID, OML_SENDER_ID, OML_SEQ, OML_TS_CLIENT, OML_TS_SERVER, TIMESTAMP, VALUE) VALUES (?, ?, ?, ?, ?, ?, ?)"
    else:
        table = "INSERT INTO \"ss_cwnd\""
        insere = "INSERT INTO SS_CWND  (OML_TUPLE_ID, OML_SENDER_ID, OML_SEQ, OML_TS_CLIENT, OML_TS_SERVER, TIMESTAMP, VALUE) VALUES (?, ?, ?, ?, ?, ?, ?)"

    lines = open("/home/victor/mysite/bokehApps/UFGtcpBitrate/banco/" + arquivo)
    tup = ()
    for line in lines:

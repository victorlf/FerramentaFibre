defProperty('server_node','omf.ufg.node1',"ID of server node")
defProperty('client_node','omf.ufg.node9',"ID of client node")
...
defProperty('iperf_isUDP', 'true', "Set Iperf UDP")

defProperty('server_node','omf.ufg.node7',"ID of server node")
defProperty('client_node','omf.ufg.node8',"ID of client node")
...
defProperty('server_tx_power', '1', 'Server Tx Power')
defProperty('client_tx_power', '1', 'Client Tx Power')
defProperty('bitrate', '24', 'Fixed bitrate value.')
...
defGroup('Server', property.server_node) do |node|
  node.addApplication("tutorials:iperf", :id => 'iperf_server') do |app|
    ...
    app.setProperty('oml-domain', 'wireless_experiment_4')
